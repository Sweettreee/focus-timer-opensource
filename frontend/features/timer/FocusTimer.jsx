...
export default function FocusTimer() {
  ...
  return (
    <div className="relative w-full h-full min-h-[510px] bg-white/40 rounded-2xl border border-gray-100/80 flex flex-col items-center justify-between overflow-hidden">
