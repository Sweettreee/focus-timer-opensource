      ...
      <main className="flex-1">
        ...
        <section className={`flex flex-col items-center justify-center text-center px-6 py-20 transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-5 opacity-0'}`}>
          ...
          <p className="text-gray-500 max-w-xl text-sm leading-relaxed mb-8">
            ...
            AI 비전 어시스턴트의 모니터링과 고요한 앰비언트 사운드 속에서, 나만의 소중한 시간을 나무로 키워보세요.
          </p>
        ...
        <section className="bg-white/50 border-y border-gray-200 py-16 px-6">
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col items-center text-center p-6 bg-white/60 rounded-xl border border-gray-100">
              ...
              <h3 className="text-base font-bold text-[#4A5D4E] mb-2">Visual Growth</h3>
              <p className="text-xs text-gray-500 leading-relaxed">
                설정한 목표 시간에 맞춰 씨앗이 나무로 성장하는 타임랩스를 볼 수 있습니다. 집중의 결과를 눈으로 확인해 보세요.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center p-6 bg-white/60 rounded-xl border border-gray-100">
              ...
              <h3 className="text-base font-bold text-[#4A5D4E] mb-2">Ambient Soundscapes</h3>
              <p className="text-xs text-gray-500 leading-relaxed">
                백색소음, 숲의 바람 소리, 빗소리 등을 직접 믹싱하여 나에게 가장 잘 맞는 최적의 집중 환경을 커스텀합니다.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="text-xs text-gray-500 mb-6 leading-relaxed">
                Focus Room에서 다른 사람들과 함께 집중 시간을 공유하고 모니터링할 수 있습니다. 이번 달 가장 깊게 몰입한 탑 랭커에 도전해 보세요.
              </p>

              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white border border-gray-200 p-4 rounded-lg">
                  <p className="text-[10px] text-gray-400 font-bold mb-1">총 집중 시간</p>
                  <p className="text-xl text-[#4A5D4E] font-bold">
                    {globalStats.totalHours.toLocaleString()} <span className="text-xs text-gray-400 font-normal">hrs</span>
                  </p>
                </div>
                
                <div className="bg-[#6B8E23]/10 border border-[#6B8E23]/20 p-4 rounded-lg">
                  <p className="text-[10px] text-[#6B8E23] font-bold mb-1">심은 나무 수</p>
                  <p className="text-xl text-[#6B8E23] font-bold">
                    {globalStats.totalTrees.toLocaleString()} <span className="text-xs text-[#6B8E23]/70 font-normal">trees</span>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm">
              <div className="flex justify-between items-center mb-4 pb-2 border-b border-gray-100">
                <div>
                  <h3 className="text-base font-bold text-[#4A5D4E]">Hall of Focus</h3>
                  <p className="text-[11px] text-gray-400">이번 달 가장 많은 나무를 피워낸 포커서</p>
                </div>
              ...
              <div className="flex flex-col gap-2">
                {rankings.length > 0 ? (
                  rankings.map((ranker, index) => (
                    <div key={ranker.id} className="flex items-center justify-between p-3 bg-[#F9F6F0] rounded-lg border border-gray-100">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-xs font-bold text-gray-800">{ranker.nickname}</p>
                          <p className="text-[10px] text-gray-500">{ranker.hours} hrs</p>
                        </div>
                      </div>
                  ...
                  <p className="text-xs text-center text-gray-400 py-4">랭킹 데이터가 없습니다.</p>
                )}
              </div>
            </div>
